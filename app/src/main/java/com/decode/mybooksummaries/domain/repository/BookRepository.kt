...
interface BookRepository {
    ...
    fun getBooksByCategory(category: String, isConnected: Boolean): Flow<Response<List<Book>>>
    ...
    fun getSearchBooks(query: String, isConnected: Boolean): Flow<Response<List<Book>>>
